...
class FilmController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $films = $em->getRepository('TestBundle:Film')->findAll();
    ...
    {
        $film = new Film();
        $form = $this->createForm('EPFC\TestBundle\Form\FilmType', $film);
    ...
    {
        $deleteForm = $this->createDeleteForm($film);
        $editForm = $this->createForm('EPFC\TestBundle\Form\FilmType', $film);
